                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="badge bg-light text-dark border fw-normal">{{ $res->heure_debut }} - {{ $res->heure_fin }}</div>
                        </td>
                        <td>
                        ...
                        <td class="text-end pe-4">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm rounded-3">
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-eye me-2"></i> Détails</a></li>
                                    <li><a class="dropdown-item text-danger" href="#"><i class="bi bi-x-circle me-2"></i> Annuler</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
...
<style>
    ...
    .avatar-sm { font-weight: 700; font-size: 0.9rem; }
